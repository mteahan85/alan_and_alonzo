...
{{
var G__14426 = cljs.core.pop.call(null,v__$1);
v__$1 = G__14426;
continue;
}
} else
...
{var pred__14430 = cljs.core._EQ_;var expr__14431 = limit;if(cljs.core.truth_(pred__14430.call(null,1,expr__14431)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__14430.call(null,2,expr__14431)))
...
var G__14433 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__14434 = (limit__$1 - 1);
var G__14435 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__14433;
limit__$1 = G__14434;
parts = G__14435;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___14437 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___14437))
{var replacement_14438 = temp__4090__auto___14437;buffer.append([cljs.core.str(replacement_14438)].join(''));
} else
{buffer.append(ch);
}
{
var G__14439 = (index + 1);
index = G__14439;
continue;
}
}
