...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__3824__auto__,writer__3825__auto__,opt__3826__auto__){return cljs.core._write.call(null,writer__3825__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_16354 = 0;while(true){
if((i_16354 < arr.length))
{(arr[i_16354] = null);
{
var G__16355 = (i_16354 + 1);
i_16354 = G__16355;
continue;
}
} else
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__3824__auto__,writer__3825__auto__,opt__3826__auto__){return cljs.core._write.call(null,writer__3825__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_16361 = (self__.level + 1);while(true){
if((i_16361 <= (new_level + 1)))
{(update[i_16361] = self__.header);
{
var G__16362 = (i_16361 + 1);
i_16361 = G__16362;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_16363 = 0;while(true){
if((i_16363 <= self__.level))
{var links_16364 = (update[i_16363]).forward;if(((links_16364[i_16363]) === x__$1))
{(links_16364[i_16363] = (x__$1.forward[i_16363]));
{
var G__16365 = (i_16363 + 1);
i_16363 = G__16365;
continue;
}
} else
{{
var G__16366 = (i_16363 + 1);
i_16363 = G__16366;
continue;
}
}
