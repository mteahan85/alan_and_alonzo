...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t16393 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t16393 = (function (val,box,meta16394){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t16393.cljs$lang$type = true;
cljs.core.async.impl.channels.t16393.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t16393";
cljs.core.async.impl.channels.t16393.cljs$lang$ctorPrWriter = (function (this__3824__auto__,writer__3825__auto__,opt__3826__auto__){return cljs.core._write.call(null,writer__3825__auto__,"cljs.core.async.impl.channels/t16393");
});
cljs.core.async.impl.channels.t16393.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t16393.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_16395){var self__ = this;
var _16395__$1 = this;return self__.meta16394;
});
cljs.core.async.impl.channels.t16393.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_16395,meta16394__$1){var self__ = this;
var _16395__$1 = this;return (new cljs.core.async.impl.channels.t16393(self__.val,self__.box,meta16394__$1));
});
cljs.core.async.impl.channels.__GT_t16393 = (function __GT_t16393(val__$1,box__$1,meta16394){return (new cljs.core.async.impl.channels.t16393(val__$1,box__$1,meta16394));
});
}
return (new cljs.core.async.impl.channels.t16393(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__3827__auto__,writer__3828__auto__,opts__3829__auto__){return cljs.core._write.call(null,writer__3828__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__3824__auto__,writer__3825__auto__,opt__3826__auto__){return cljs.core._write.call(null,writer__3825__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_16396 = self__.takes.pop();if((taker_16396 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_16396))
{var take_cb_16397 = cljs.core.async.impl.protocols.commit.call(null,taker_16396);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_16397,taker_16396){
return (function (){return take_cb_16397.call(null,null);
});})(take_cb_16397,taker_16396))
);
} else
{}
{
