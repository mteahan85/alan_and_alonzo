...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_16387 = 0;while(true){
var m_16388 = cljs.core.async.impl.dispatch.tasks.pop();if((m_16388 == null))
{} else
{m_16388.call(null);
if((count_16387 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__16389 = (count_16387 + 1);
count_16387 = G__16389;
continue;
}
} else
{}
